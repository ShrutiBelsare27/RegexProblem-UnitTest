...
namespace NUnitUserRegistration
{
    public class Tests
    {
       ...
       [SetUp]
        ...
        public void Test1()
        {
            var result = fs.FirstName("Shruti", firstName);
        ...
        public void Test2()
        {
            var result = fs.LastName("Belsare", lastName);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test3()
        {
            var result = fs.Email("shruti123@gmail.com", email);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test4()
        {
            var result = fs.PhoneNumber("91 9878786877", phoneNumber);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test6()
        {
            var result = fs.Password2("Shrutibl", password2);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test7()
        {
            var result = fs.Password3("Shruti98", password3);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test8()
        {
            var result = fs.Password4("Shruti#@", password4);
            Assert.AreEqual(true, result.Success);
        ...
        public void Test9()
        {
            var result = fs.Email1("sHruti12@gmail.com", email1);
            Assert.AreEqual(true, result.Success);
